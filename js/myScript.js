var myWeatherApp = {
  ...
  codeLocation: function(results, status){//this points the marker at the location inputed or submitted
  ...
  placeMarker: function(location) {//this is for when the map is clicked
    ...
    myWeatherApp.loadWeather(location.lat() + ',' + location.lng());
     console.log(location.latlocation.lng);
  ...
  setupListeners: function(){
    ...
    google.maps.event.addListener(myWeatherApp.config.map, 'click', function(event) {//this is what calls the 
      //placemarker function when the map is clicked
